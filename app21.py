...
# Schema atualizado com o nome correto da tabela
def get_schema(_):
    return """
    Tabela 'despesas':  # Alterado de 'empenhos_completos' para 'despesas'
...
# Template SQL 
template_sql = """Com base no schema da tabela abaixo, escreva uma query SQL que responda à pergunta:
...
prompt = st.chat_input("Ex: Traga todo os dados de dezembro de 2024")
        ...
        with st.spinner("Processando..."):
            try:
                ...
                if df is not None and not df.empty:
                    ...
                    # Aplicar formatação em colunas específicas
